"""
theme.py — Gradio theme and all custom CSS/JS for Slack Bot Studio.
"""

import gradio as gr

# ---------------------------------------------------------------------------
# Gradio Theme — use Base to avoid color-scheme conflicts with dark CSS
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# JS for js_on_load — auto-scrolls the log terminal on every DOM mutation
# ---------------------------------------------------------------------------
LOG_AUTOSCROLL_JS = """
(function() {
    function scrollLogs() {
